...
def parse_args():
    ...
    parser.add_argument('--distmodal', action='store_false', default=True,
    ...
    parser.add_argument('--n_classes', type=int, default=3, help='number of modal_classifier label type(self.organ2label)')
