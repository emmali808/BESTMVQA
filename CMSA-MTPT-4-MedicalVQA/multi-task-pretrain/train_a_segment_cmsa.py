...
def get_arguments():
    ...
    parser.add_argument('-dictionary_path', type=str, default='/home/coder/projects/CMSA-MTPT-4-MedicalVQA/data_RAD/dictionary.pkl')
    parser.add_argument('-RAD_dir', type=str, default='/home/coder/projects/CMSA-MTPT-4-MedicalVQA/data_RAD')
