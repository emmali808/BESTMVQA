...
def _load_dataset(dataroot, name, img_id2val, label2ans):
    ...
    if 'SLAKE' in dataroot or 'Med-2019' in dataroot or 'OVQA' in dataroot :
...
class VQAFeatureDataset(Dataset):
    def __init__(self, name, args, dictionary, dataroot='data', question_len=12):
        ...
        if args.maml:
            # TODO: load images
            if 'SLAKE' in self.args.VQA_dir or 'Med-2019' in self.args.VQA_dir or 'OVQA' in self.args.VQA_dir:
        ...
        if args.autoencoder:
            # TODO: load images
            if 'RAD' in self.args.VQA_dir or 'SLAKE' in self.args.VQA_dir or 'Med-2019' in self.args.VQA_dir  or 'OVQA' in self.args.VQA_dir:
    ...
    def tensorize(self):
        ...
        if self.args.autoencoder:
            ## alter by hxj
            if 'RAD' in self.args.VQA_dir or 'SLAKE' in self.args.VQA_dir or 'Med-2019' in self.args.VQA_dir:
