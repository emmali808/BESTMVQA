...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_dir', type=str, default = '/home/coder/projects/PubMedCLIP-main/PubMedCLIP/roco/ROCO/roco/roco-dataset-master/data', help='path to dataset', required = False)
    parser.add_argument('--save_dir', type=str, default = '../ROCO/roco/roco-dataset-master/data/medvqa/Weights/roco_mlm', help='save model weights in this dir', required = False)
    ...
    trainloader = DataLoader(traindataset, batch_size = args.batch_size, shuffle=False, num_workers = args.num_workers)
