...
class LlavaLlamaModel(LlamaModel):
    ...
    def __init__(self, config: LlamaConfig, mm_vision_tower=None, mm_hidden_size=None):
        ...
        self.vision_tower_name = "/public/home/wangcheng/LLaVA-Med-Repo/llava/path/to/clip-vit" # microsoft/BiomedCLIP-PubMedBERT_256-vit_base_patch16_224 # openai/clip-vit-large-patch14
        if hasattr(config, "mm_vision_tower"):
            ...
            if "BiomedCLIP" in config.mm_vision_tower or "biomed_clip" in config.mm_vision_tower:
                ...
                self.vision_tower = [CLIPVisionModel.from_pretrained("/public/home/wangcheng/LLaVA-Med-Repo/llava/path/to/clip-vit")]
