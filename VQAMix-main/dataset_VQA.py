...
def _load_dataset(dataroot, name, img_id2val, label2ans):
    ...
    ## alter by hxj
    if 'SLAKE' in dataroot or 'Med-2019' in dataroot:
...
class VQAFeatureDataset(Dataset):
    def __init__(self, name, args, dictionary, dataroot='data', question_len=12):
        ...
        if args.maml:
            # TODO: load images
            if 'SLAKE' in self.args.RAD_dir or 'Med-2019' in self.args.RAD_dir:
        ...
        if args.autoencoder:
            # TODO: load images
            if 'RAD' in self.args.RAD_dir or 'SLAKE' in self.args.RAD_dir or 'Med-2019' in self.args.RAD_dir:
