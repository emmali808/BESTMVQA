...
# CUDA_VISIBLE_DEVICES=0 python3 main.py --model SAN --use_RAD --RAD_dir data_PathVQA --output saved_model_path/SAN_MEVF-PATH-VQAMix-0 --batch_size 128 --epochs 80 --use_mix --alpha=1 --use_mix_cond --use_mix_cond_q --seed 0
