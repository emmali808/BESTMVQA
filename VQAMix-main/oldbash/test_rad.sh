...
# CUDA_VISIBLE_DEVICES=0 python3 main.py --model SAN --use_RAD --RAD_dir data_RAD --output saved_model_rad/BAN_MEVF-RAD-VQAMix-3 --epochs 80 --use_mix --alpha=1 --use_mix_cond --use_mix_cond_q --seed 3
CUDA_VISIBLE_DEVICES=0 python3 test.py --model SAN --use_RAD --RAD_dir data_RAD --input saved_model_rad/BAN_MEVF-RAD-VQAMix-3 --output="results-RAD"
