...
CUDA_VISIBLE_DEVICES=0 python3 main.py --model $1 --use_RAD --RAD_dir $2 --output saved_model_rad/BAN_MEVF-RAD-VQAMix-3 --epochs 80 --use_mix --alpha=1 --use_mix_cond --use_mix_cond_q --seed 3
