...
class VQAFeatureDataset(Dataset):
    ...
    def tensorize(self):
        if self.args.maml:
            if 'data_Med' in self.args.medvqa2019_dir:
    ...
    def __getitem__(self, index):
        ...
        if None!=answer:
            ...
            # return image_data, question, target, answer_type, question_type, None
