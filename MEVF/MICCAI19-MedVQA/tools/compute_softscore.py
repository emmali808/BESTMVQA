...
if __name__ == '__main__':
    ...
    train_answers = json.load(open(RAD_dir + '/trainset.json', encoding='utf-8'))
    ...
    if os.path.isfile(cache_path):
        ...
        ans2label = create_ans2label(occurence, 'trainval', cache_root='/home/coder/projects/Med-VQA/data_PATH/cache')

    compute_target(train_answers, ans2label, 'train', cache_root='/home/coder/projects/Med-VQA/data_PATH/cache')

    test_answers = json.load(open(RAD_dir + '/testset.json'))
    compute_target(test_answers, ans2label, 'test', cache_root='/home/coder/projects/Med-VQA/data_PATH/cache')


    val_target = json.load(open(RAD_dir + '/valset.json'))

    compute_target(val_target, ans2label, 'val', cache_root='/home/coder/projects/Med-VQA/data_PATH/cache')